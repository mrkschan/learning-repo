 ...
 * @author kschan
 */
public class CategoryVisitStats extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        wb.setSheetName(0, "stats_by_category");
        ...
        try {
            ...
            List<Map<String, Object>> views = m.getCategoryViews();

            HashMap<String, Integer> counts = new HashMap<String, Integer>();

            for (Map<String, Object> v: views) {
                String category = v.get("category").toString();
